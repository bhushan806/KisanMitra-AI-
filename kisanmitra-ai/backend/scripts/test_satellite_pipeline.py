...
def test_pipeline():
    ...
    if count > 0:
        ...
        logger.warning(
            f"FAILURE/WARNING: No records found in MongoDB for {test_date_str}. (This could happen if no non-cloudy images were available for this specific date across all 4 districts)."
        )
    logger.info("====================================")

  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-white/5 pb-6">
        ...
        <div className="text-right">
          ...
          <div className={cn(
            ...
            isFarmer ? "bg-zinc-800 text-zinc-300 border-zinc-700" : "bg-blue-500/10 text-blue-400 border-blue-500/20"
          )}>
      ...
      <motion.div 
        ...
        className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-blue-900 to-zinc-950 border border-white/10 p-8 shadow-2xl"
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
          <div>
            ...
            <div className="flex items-baseline space-x-2">
              <span className="text-7xl font-black text-white tracking-tighter">28°</span>
          ...
          <div className="grid grid-cols-2 gap-4 w-full md:w-auto">
            {isFarmer ? (
              <>
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 text-center flex flex-col items-center justify-center">
                  <CloudRain className="w-8 h-8 text-blue-300 mb-2" />
                  <span className="text-lg font-bold text-white">Rain Expected</span>
                </div>
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 text-center flex flex-col items-center justify-center">
                  <Wind className="w-8 h-8 text-blue-300 mb-2" />
                  <span className="text-lg font-bold text-white">Normal Wind</span>
                </div>
              </>
            ) : (
              <>
                ...
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                  ...
                  <span className="text-2xl font-bold text-white">14 <span className="text-sm text-blue-300">km/h</span></span>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                  ...
                  <span className="text-2xl font-bold text-white">45 <span className="text-sm text-blue-300">mm</span></span>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                  ...
                  <span className="text-2xl font-bold text-white">1008 <span className="text-sm text-blue-300">hPa</span></span>
                </div>
              </>
            )}
          </div>
      ...
      >
        <h3 className="text-lg font-bold text-zinc-100 mb-4 flex items-center">
          <CalendarDaysIcon className="w-5 h-5 mr-2 text-zinc-500" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-7 gap-4">
          {[
            ...
            <div key={d.day} className="bg-zinc-900/50 backdrop-blur-md border border-white/5 rounded-2xl p-4 flex flex-col items-center hover:bg-zinc-800/50 transition-colors">
              <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-3">{d.day}</span>
              <d.icon className={cn("w-8 h-8 mb-3", d.icon === Sun ? "text-yellow-500" : d.icon === CloudLightning ? "text-red-400" : "text-blue-400")} />
              <span className="text-lg font-bold text-zinc-100">{d.temp}°</span>
            </div>
          ))}
        </div>
      </motion.div>

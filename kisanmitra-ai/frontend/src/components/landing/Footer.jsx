    ...
    <footer className="bg-gray-900 pt-20 pb-8 text-gray-300">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              Empowering farmers across India with artificial intelligence to make data-driven decisions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="hover:text-primary transition-colors">Price Prediction</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Crop Recommendation</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Disease Detection</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Weather Forecast</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Yield Analytics</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li>info@kisanmitra.ai</li>
              <li>+91 98765 43210</li>
              <li>123 Agri-Tech Park,</li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          <p>© {new Date().getFullYear()} KisanMitra AI. All rights reserved.</p>
